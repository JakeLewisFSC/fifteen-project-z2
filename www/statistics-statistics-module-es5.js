...
var StatisticsPageRoutingModule = /** @class */ (function () {
    function StatisticsPageRoutingModule() {
    }
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/fesm5/angular-fire-firestore.js");
...
var StatisticsPage = /** @class */ (function () {
    function StatisticsPage(platformLocation, afs, afAuth, 
    //qr: NgxQRCodeModule,
    modalCtrl, 
    ...
    StatisticsPage.prototype.load = function (name) {
        this.project = name;
        this.unityView.loadProject("../../../assets/" + name + "/" + name + ".json");
    };
    StatisticsPage.prototype.send = function (objectName, methodName, messageValue) {
        this.unityView.sendMessageToUnity(objectName, methodName, messageValue);
    };
    //email = "perDQBAB2cP48ChbcUixU7ykbbP2";
    StatisticsPage.prototype.normalLogin = function (email, password) {
    ...
    StatisticsPage.prototype.SignOut = function () {
    ...
    StatisticsPage.prototype.ngOnInit = function () {
        ...
        this.routeParams = this.route.params.subscribe(function (params) {
            ...
            _this.WorkoutCollection = _this.afs.doc(_this.accounts + _services_auth_service__WEBPACK_IMPORTED_MODULE_8__["__email"]).collection('Workouts', function (ref) { return ref.orderBy('Time'); });
            _this.myAny = _this.WorkoutCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (actions) {
...
var UnityComponent = /** @class */ (function () {
    function UnityComponent() {
    }
    UnityComponent.prototype.ngOnInit = function () {
