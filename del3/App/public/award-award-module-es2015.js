...
let AwardPage = class AwardPage {
    ...
    ngOnInit() {
        this.routeParams = this.route.params.subscribe(params => {
            ...
            this.afs.collection('users').doc(_login_login_page__WEBPACK_IMPORTED_MODULE_6__["__id"]);
            this.myAny = this.afs.collection('users').doc(_login_login_page__WEBPACK_IMPORTED_MODULE_6__["__id"]).snapshotChanges().subscribe(values => {
                ...
                if (data.Trophies) {
                    ...
                    if (_login_login_page__WEBPACK_IMPORTED_MODULE_6__["__email"] != "") {
                        ...
                        this.afs.collection('users').doc(_login_login_page__WEBPACK_IMPORTED_MODULE_6__["__id"]).set({ Trophies: this.list }, { merge: true });
