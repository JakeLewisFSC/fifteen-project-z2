...
var StatisticsPage = /** @class */ (function () {
    function StatisticsPage(platformLocation, afs, afAuth) {
        ...
        this.accounts = "users/";
        this.email = "perDQBAB2cP48ChbcUixU7ykbbP2";
    ...
    StatisticsPage.prototype.ngOnInit = function () {
        this.WorkoutCollection = this.afs.doc(this.accounts + this.email).collection('Workouts', function (ref) { return ref.orderBy('Time'); });
        this.myAny = this.WorkoutCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (actions) {
