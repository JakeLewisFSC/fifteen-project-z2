...
var StatisticsPage = /** @class */ (function () {
    ...
    StatisticsPage.prototype.ngOnInit = function () {
        ...
        this.WorkoutCollection = this.afs.doc(this.accounts + _services_auth_service__WEBPACK_IMPORTED_MODULE_6__["__email"]).collection('Workouts', function (ref) { return ref.orderBy('Time'); });
